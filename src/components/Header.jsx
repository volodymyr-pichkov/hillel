    ...
    <header className="w-full h-auto max-w-[1366px] max-h-[91px] flex justify-between items-center bg-layout-white">
      <div className="flex justify-center items-center">
        <img
          ...
          alt="logo"
        />
        <h1 className="flex flex-col text-title-dark font-work text-xl not-italic leading-normal font-bold justify-center w-[112px] h-[14px] mt-[39px] mr-[80px] mb-[38px]">Чіп Чендж</h1>
      </div>
      <nav>
      ...
      <a href="#" className="flex items-center font-roboto non-italic font-normal leading-normal w-[144px] h-[11px] mt-[42px] mr-[87px] mb-[38px]">Особистий кабінет</a>
      </div>
    </header>
  );
};
